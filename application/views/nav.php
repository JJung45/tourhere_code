<div class="clearfix hMenu">
    <div class="center gnb">
        ...
        <ul>
            <li class="mainM"><a href="/index.php/board/main?search=1">Accomodation</a></li>
            <li class="mainM"><a href="/index.php/board/main?search=2">Restaurant</a></li>
            <li class="mainM"><a href="/index.php/board/main?search=3">Attractions</a></li>
            <li class="loginjoin">
                <?php
